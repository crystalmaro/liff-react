...
export default class ScratchoffClass extends Component {
  state = {
    isDrawing: false,
    lastPoint: null
  };
  ...
  componentDidMount() {
    ...
    this.cover.src =
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRJUfpqnOLlKhnWKJF7RiuFniQeCdwfnu6ZEg&usqp=CAU";
    this.cover.onload = () =>
  ...
  checkFilledPercent = () => {
    ...
    if (percentage > completePercent) {
      console.log(completePercent);
      alert(`scratched over ${completePercent}%`);
      // alert("scratched over 22")
    }
  };
